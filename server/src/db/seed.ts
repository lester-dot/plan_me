...
const competencies = [
  { id: "ok01", code: "ОК.01", title: "Выбирать способы решения задач профессиональной деятельности", cluster: "универсальные", knowledge: ["виды профессиональных задач", "алгоритмы принятия решений"], skills: ["анализировать условия задачи", "выбирать инструменты решения"], habits: ["фиксировать результат", "проверять качество решения"], indicators: ["формулирует задачу", "обосновывает выбранный способ", "оценивает результат"] },
  { id: "ok02", code: "ОК.02", title: "Использовать цифровые средства и информацию", cluster: "универсальные", knowledge: ["источники данных", "правила работы с цифровыми сервисами"], skills: ["искать и структурировать информацию", "работать с таблицами и учетными системами"], habits: ["соблюдать цифровую гигиену", "хранить подтверждающие материалы"], indicators: ["использует ПО в задаче", "обрабатывает данные", "прикрепляет цифровой результат"] },
  { id: "ok03", code: "ОК.03", title: "Планировать профессиональное и личностное развитие", cluster: "универсальные", knowledge: ["траектории развития", "критерии профессиональной готовности"], skills: ["ставить цели", "планировать шаги развития"], habits: ["обновлять портфолио", "сравнивать текущий уровень с целевым"], indicators: ["видит дефициты", "обновляет план", "использует обратную связь"] },
  { id: "pk01", code: "ПК.01", title: "Организовывать торговую деятельность и обслуживание покупателей", cluster: "профессиональные", knowledge: ["этапы торгового процесса", "правила обслуживания покупателей"], skills: ["готовить торговое пространство", "консультировать покупателя", "оформлять продажу"], habits: ["соблюдать стандарты сервиса", "контролировать качество обслуживания"], indicators: ["выстраивает процесс продажи", "работает с возражениями", "соблюдает регламенты"] },
  { id: "pk02", code: "ПК.02", title: "Вести учет, анализ и документооборот торговой организации", cluster: "профессиональные", knowledge: ["первичные документы", "показатели финансово-хозяйственной деятельности"], skills: ["оформлять документы", "анализировать продажи и остатки", "использовать учетное ПО"], habits: ["проверять полноту данных", "соблюдать сроки документооборота"], indicators: ["готовит документы", "объясняет показатели", "находит отклонения"] },
  { id: "pk03", code: "ПК.03", title: "Организовывать предпринимательскую деятельность в сфере торговли", cluster: "профессиональные", knowledge: ["модели торгового бизнеса", "налоги и правовые формы", "финансовое планирование"], skills: ["рассчитывать экономику проекта", "готовить бизнес-гипотезу", "презентовать решение"], habits: ["проверять спрос", "считать риски", "собирать обратную связь"], indicators: ["описывает бизнес-модель", "считает выручку и расходы", "защищает проект"] },
  { id: "pk04", code: "ПК.04", title: "Использовать интернет-маркетинг и цифровые каналы продаж", cluster: "профессиональные", knowledge: ["каналы продвижения", "воронка продаж", "метрики интернет-маркетинга"], skills: ["создавать контент", "планировать кампанию", "оценивать эффективность"], habits: ["тестировать гипотезы", "вести аналитику", "улучшать коммуникацию"], indicators: ["собирает медиаплан", "настраивает цифровой канал", "оценивает метрики"] },
] as const;
